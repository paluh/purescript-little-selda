...
leftExp = Select { columns: [Named "vegsId_1" (Column "vegsId")], source: TableName "favoriteVegs", restricts: [], groups: [], ordering: [], limits: Nothing }

rightExp = Select { columns: [Named "colour_2" (Column "colour"), Named "id_3" (Column "id")], source: TableName "vegs", restricts: [], groups: [], ordering: [] , limits: Nothing}
